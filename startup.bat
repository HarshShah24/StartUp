...
start /d "C:\Program Files (x86)\Google\Chrome\Application\" chrome

start /d "C:\Program Files\FileZilla FTP Client\" filezilla

start /d "C:\Program Files\Perforce\" p4V

start /d "C:\Users\harsshah\Downloads\Softwares\Development\VFIT\sqldeveloper\" sqldeveloper
